...
return [
    ...
    'directory_list' => [
        'src',
        'vendor/auth0/auth0-php/src',
        'vendor/guzzlehttp/guzzle/src',
        'vendor/guzzlehttp/psr7/src',
        'vendor/http-interop/http-factory-guzzle/src',
        ...
        'vendor/php-contrib/response-filter/src',
        'vendor/php-contrib/serializer/src',
        'vendor/php-contrib/validator/src',
        'vendor/php-coveralls/php-coveralls/src',
        'vendor/phpolar/csrf-protection/src',
        'vendor/phpolar/csrf-response-filter/src',
        'vendor/phpolar/http-request-processor/src',
        'vendor/phpolar/property-injector-contract/src',
        'vendor/phpolar/model-resolver/src',
        'vendor/phpolar/model/src',
        'vendor/phpolar/mysql-storage/src',
        'vendor/phpolar/phpolar/src',
        'vendor/phpolar/pure-php/src',
        'vendor/phpolar/sqlite-storage/src',
        'vendor/phpolar/storage/src',
        'vendor/phpolar/validators/src',
        'vendor/phpunit/phpunit/src',
        'vendor/pimple/pimple/src',
        'vendor/http-interop/http-factory-guzzle/src',
        'vendor/php-common-enums/http-method/src',
        'vendor/php-common-enums/http-response-code/src',
        'vendor/php-common-enums/mime-type/src',
